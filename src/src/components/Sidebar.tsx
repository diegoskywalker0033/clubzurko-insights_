...
import {LayoutDashboard,Users,Megaphone,Database,Wallet,Upload,ChevronRight,Menu,X,TrendingUp,AlertTriangle,BarChart2} from 'lucide-react'
...
const navItems=[
  ...
  {href:'/retrasos',label:'Retrasos',icon:AlertTriangle},
